...
- my game here in the Roblox platform, named *"the rake: retro!!"*; a one designed to deliver you what The Rake by RVVZ would feel in the ~2009 era of ROBLOX. after seeing how rejected AI apparently was when it came to making games solely with it, I wanted to prove that thought wrong - so I made *this* game which only has scripts that are made with AI assistants & agents - or scripts taken straight up from the Roblox Toolbox that are modified with AI.
